# ==============================================================================
# SentinelAI - ECS Fargate Module
# ECS Cluster, Task Definitions, Services, ALB, Auto-scaling
# ==============================================================================
...
resource "aws_lb_listener_rule" "api" {
  ...
  condition {
    path_pattern {
      values = ["/api/*", "/health", "/docs", "/redoc", "/openapi.json", "/metrics"]
    }
  }
}
...
resource "aws_ecs_task_definition" "frontend" {
  ...
  container_definitions = jsonencode([{
    ...
    environment = [
      { name = "NEXT_PUBLIC_API_URL", value = "https://${var.project_name}.example.com/api/v1" },
      { name = "NEXT_PUBLIC_APP_NAME", value = "SentinelAI" }
    ]
...
resource "aws_appautoscaling_policy" "backend_cpu" {
  ...
  target_tracking_scaling_policy_configuration {
    ...
    target_value       = var.backend_auto_scaling_target
